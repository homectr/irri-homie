...
#define DEBUG_ARRAY(ARR, ARR_L)                    \
  for (uint16_t _aidx = 0; _aidx < ARR_L; _aidx++) \
  {                                                \
    DEBUG_PORT.printf("%02X ", *(ARR + _aidx));    \
    if (_aidx % 20 == 19)                          \
      DEBUG_PORT.printf("\n");                     \
  }
#define DEBUG_ARRAY_F(ARR, ARR_L, ARR_F)           \
  for (uint16_t _aidx = 0; _aidx < ARR_L; _aidx++) \
  {                                                \
    DEBUG_PORT.printf(ARR_F, *(ARR + _aidx));      \
    if (_aidx % 20 == 19)                          \
      DEBUG_PORT.printf("\n");                     \
  }
...
#define CONSOLE_ARRAY(ARR, ARR_L)                  \
  for (uint16_t _aidx = 0; _aidx < ARR_L; _aidx++) \
  {                                                \
    CONSOLE_PORT.printf("%02X ", *(ARR + _aidx));  \
    if (_aidx % 20 == 19)                          \
      CONSOLE_PORT.printf("\n");                   \
  }
#define CONSOLE_ARRAY_F(ARR, ARR_L, ARR_F)         \
  for (uint16_t _aidx = 0; _aidx < ARR_L; _aidx++) \
  {                                                \
    CONSOLE_PORT.printf(ARR_F, *(ARR + _aidx));    \
    if (_aidx % 20 == 19)                          \
      CONSOLE_PORT.printf("\n");                   \
  }
